...
<body class="isPC">
    ...
    <div class="wrapper">
        <div class="stage_result"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 72 72" class="wd-icon-svg wd-icon-svg-info_attention_72 comm_infoAttention72_Red">
            ...
            <div class="spam_title">Tank You</div>
